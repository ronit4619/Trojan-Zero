...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 py-5 px-5">
                    ...
                    <p class="mt-2">TrojanZERO is a thermal surveillance-based security system used to prevent city-wide infiltration during times of war and/or invasion. The thermal camera system can detect intruders within the city to keep citizens safe. Positioned throughout
    ...
    <section id="team" class="text-center py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="team-member mx-auto mb-5 mb-lg-0">
